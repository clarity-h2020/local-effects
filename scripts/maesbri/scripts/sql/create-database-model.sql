...
CREATE TABLE laea_etrs_500m_e09n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 0) TO (9000, 9000);
CREATE TABLE laea_etrs_500m_e09n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 9001) TO (9000, 17000);
CREATE TABLE laea_etrs_500m_e09n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 17001) TO (9000, 26000);
CREATE TABLE laea_etrs_500m_e09n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 26001) TO (9000, 35000);
CREATE TABLE laea_etrs_500m_e09n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 35001) TO (9000, 44000);
CREATE TABLE laea_etrs_500m_e09n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 44001) TO (9000, 54000);
CREATE TABLE laea_etrs_500m_e09n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (0, 45001) TO (9000, MAXVALUE);
CREATE TABLE laea_etrs_500m_e17n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 9000) TO (17000, 9000);
CREATE TABLE laea_etrs_500m_e17n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 17000) TO (17000, 17000);
CREATE TABLE laea_etrs_500m_e17n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 26000) TO (17000, 26000);
CREATE TABLE laea_etrs_500m_e17n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 35000) TO (17000, 35000);
CREATE TABLE laea_etrs_500m_e17n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 44000) TO (17000, 44000);
CREATE TABLE laea_etrs_500m_e17n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (9000, 54000) TO (17000, 54000);
CREATE TABLE laea_etrs_500m_e25n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 9000) TO (25000, 9000);
CREATE TABLE laea_etrs_500m_e25n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 17000) TO (25000, 17000);
CREATE TABLE laea_etrs_500m_e25n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 26000) TO (25000, 26000);
CREATE TABLE laea_etrs_500m_e25n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 35000) TO (25000, 35000);
CREATE TABLE laea_etrs_500m_e25n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 44000) TO (25000, 44000);
CREATE TABLE laea_etrs_500m_e25n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (17000, 54000) TO (25000, 54000);
CREATE TABLE laea_etrs_500m_e33n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 9000) TO (33000, 9000);
CREATE TABLE laea_etrs_500m_e33n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 17000) TO (33000, 17000);
CREATE TABLE laea_etrs_500m_e33n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 26000) TO (33000, 26000);
CREATE TABLE laea_etrs_500m_e33n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 35000) TO (33000, 35000);
CREATE TABLE laea_etrs_500m_e33n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 44000) TO (33000, 44000);
CREATE TABLE laea_etrs_500m_e33n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (25000, 54000) TO (33000, 54000);
CREATE TABLE laea_etrs_500m_e41n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 9000) TO (41000, 9000);
CREATE TABLE laea_etrs_500m_e41n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 17000) TO (41000, 17000);
CREATE TABLE laea_etrs_500m_e41n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 26000) TO (41000, 26000);
CREATE TABLE laea_etrs_500m_e41n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 35000) TO (41000, 35000);
CREATE TABLE laea_etrs_500m_e41n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 44000) TO (41000, 44000);
CREATE TABLE laea_etrs_500m_e41n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (33000, 54000) TO (41000, 54000);
CREATE TABLE laea_etrs_500m_e49n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 9000) TO (49000, 9000);
CREATE TABLE laea_etrs_500m_e49n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 17000) TO (49000, 17000);
CREATE TABLE laea_etrs_500m_e49n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 26000) TO (49000, 26000);
CREATE TABLE laea_etrs_500m_e49n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 35000) TO (49000, 35000);
CREATE TABLE laea_etrs_500m_e49n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 44000) TO (49000, 44000);
CREATE TABLE laea_etrs_500m_e49n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (41000, 54000) TO (49000, 54000);
CREATE TABLE laea_etrs_500m_e57n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 9000) TO (57000, 9000);
CREATE TABLE laea_etrs_500m_e57n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 17000) TO (57000, 17000);
CREATE TABLE laea_etrs_500m_e57n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 26000) TO (57000, 26000);
CREATE TABLE laea_etrs_500m_e57n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 35000) TO (57000, 35000);
CREATE TABLE laea_etrs_500m_e57n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 44000) TO (57000, 44000);
CREATE TABLE laea_etrs_500m_e57n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (49000, 54000) TO (57000, 54000);
CREATE TABLE laea_etrs_500m_e66n09 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 9000) TO (66000, 9000);
CREATE TABLE laea_etrs_500m_e66n17 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 17000) TO (66000, 17000);
CREATE TABLE laea_etrs_500m_e66n26 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 26000) TO (66000, 26000);
CREATE TABLE laea_etrs_500m_e66n35 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 35000) TO (66000, 35000);
CREATE TABLE laea_etrs_500m_e66n44 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 44000) TO (66000, 44000);
CREATE TABLE laea_etrs_500m_e66n54 PARTITION OF laea_etrs_500m FOR VALUES FROM (57000, 54000) TO (66000, 54000);
CREATE TABLE laea_etrs_500m_default PARTITION OF laea_etrs_500m FOR VALUES FROM (MINVALUE, MINVALUE) TO (MAXVALUE, MAXVALUE);
