...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.water_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.roads_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.trees_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.vegetation_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.agricultural_areas_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.built_up_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.built_open_spaces_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.dense_urban_fabric_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.medium_urban_fabric_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.low_urban_fabric_seq;"
...
then
	...
	psql -U "postgres" -d "clarity" -c "DROP SEQUENCE public.public_military_industrial_seq;"
