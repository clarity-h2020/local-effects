...
#ogr2ogr -sql "SELECT area,perimeter,"$CODE" FROM "$SHP" WHERE "$CODE"='12100'" $NAME $FILE
ogr2ogr -overwrite -sql "SELECT Shape_Area as area, Shape_Leng as perimeter FROM "$SHP" WHERE "$CODE"='12100'" $NAME $FIL
