...
#TO-DO
#clip the rasterization to the original UA layer area?!
#shp with nodata values to shp only with data value equal to 1
#ogr2ogr -sql "SELECT * FROM "$NAME" WHERE value='1'" outfile.shp $SHP2
